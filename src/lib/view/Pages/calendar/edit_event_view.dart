...
import 'package:uni/view/Widgets/calendar/event_appbar_button.dart';
import 'package:uni/view/Widgets/calendar/event_text_input.dart';

import '../../../utils/utils.dart';
import '../../Widgets/calendar/rounded_large_button.dart';
...
class _EditEventState extends GeneralPageViewState {
  String eventName = 'Unnamed Event';
  String eventLocation = 'No location provided';
  ...
  bool hasInit = false;
  int iconValue = iconList.indexOf(tappedEvent.icon);
  ...
  void _initValues() {
    eventName = tappedEvent.name;
    eventLocation = tappedEvent.location;
    eventDescription = tappedEvent.description;
    eventDate = tappedEvent.date;
    eventType = tappedEvent.type;
    eventColor = tappedEvent.color;
    eventIcon = tappedEvent.icon;
  }
                      ...
                      key: Key('Save Button'),
                        ...
                        onPressed: (context){
                          Event newEvent = Event(
                              ...
                              eventType, eventColor, eventIcon);

                          eventMap[tappedEvent.date]?.removeWhere((element) => element == tappedEvent);
